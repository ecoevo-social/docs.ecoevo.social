...
8. AI generated content shall be clearly labeled as such. AI agents are not authorized to sign up.

## Details about the rules

- Sharing a paper, even behind a paywall, will not be considered as advertisement.
However, we highly encourage posters to prioritize sharing through open-access versions of
the papers (such as preprint servers, paper repositories like HAL, or over means bypassing paywalls).

::: {.callout-warning}
## Regarding attempts to abuse these anti-abuse tools and policies {#rules-abuse-callout}

Following the [Scholar Social community’s guidelines](https://scholar.social/about/more#regarding-attempts-to-abuse-these-anti-abuse-tools-and-policies):
...
These rules are not set in stone and community-suggested changes in wording or the addition of rules is welcomed.
See the section [How to contribute](./how-to-contribute.html).

In addition to the community guidelines we put in place, the hosting service we are using, [toot.io](https://toot.io/mastodon_hosting.html), has its own terms of service as well. They can be found [here](https://toot.io/mastodon_terms.html).
