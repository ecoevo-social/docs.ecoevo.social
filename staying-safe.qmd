...
Muting a user will avoid you to see their toots, unless they tag you.
...
No notification is sent to the other user that you reported them or or their post.

Reports should be used as often as necessary to ensure the server stays a welcoming space.

### Ask for a domain ban

Entire servers can be limited or banned interacting with our server.
This is useful for example to filter hate speech, spam,
or inapropriate content servers.

We will try to block those as we go based on known lists or
through user reports.
However if you notice one of those servers,
...
where you will find a set of granular settings on when and which posts will be deleted.
